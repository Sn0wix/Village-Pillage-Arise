...
public class ModBlocks {
    ...
    private static Block registerBlock(String name, Block block, ItemGroup group){
        ...
        return Registry.register(Registry.BLOCK, new Identifier(VillagePillageAriseMain.MOD_ID, name),block);
    }

    private static Item registerBlockItem(String name, Block block, ItemGroup group) {
        return Registry.register(Registry.ITEM, new Identifier(VillagePillageAriseMain.MOD_ID, name), new BlockItem(block, new FabricItemSettings().group(group)));
    }
