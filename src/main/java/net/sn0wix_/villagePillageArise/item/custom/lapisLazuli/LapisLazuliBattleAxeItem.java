...
public class LapisLazuliBattleAxeItem extends MiningToolItem implements Vanishable {
    public LapisLazuliBattleAxeItem(ToolMaterial material, float attackDamage, float attackSpeed, Settings settings) {
